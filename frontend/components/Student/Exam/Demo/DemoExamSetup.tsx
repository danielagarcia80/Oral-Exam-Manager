...
export default function DemoExamSetup() {
  ...
  const examFiles: ExamFiles = {
    java: {
      ...
      'Employee Management with Inheritance':
        '/SampleCode/Employee_Management_with_Inheritance.java',
    },
    'c++': {
  ...
  const handleExamSelection = (value: string | null) => {
    ...
    const selectedExamLabel =
      examOptionsPerLanguage[examLanguage as keyof ExamOptions].find((exam) => exam.value === value)
    ...
    <Flex justify="center" align="center" style={{ height: '100vh' }}>
      <Container size={800}>
        <Paper shadow="xl" radius="md" p="lg">
          ...
          <Text
            size="md"
            style={{ marginTop: '4%', textAlign: 'left', fontSize: '17px', fontWeight: '600' }}
          >
            Choose Exam:
          </Text>
          <Select

...
export default function EditQuestionDetails({questions, examLinkedQuestions, updateExamQuestions}: Props) {
        ...
        return(
                ...
                <div style={{marginTop: "2%"}}>
                        ...
                        <AddQuestionsModal questions={questions} examLinkedQuestions={examLinkedQuestions} setExamQuestions={updateExamQuestions} updateExamQuestions={updateExamQuestions}/>
                </div>
                </>
        );
}
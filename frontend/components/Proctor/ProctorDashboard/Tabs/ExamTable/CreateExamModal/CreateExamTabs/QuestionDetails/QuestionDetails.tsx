...
export default function QuestionDetails({questions, updateExamQuestions}: Props) {
        ...
        return(
                ...
                <div style={{marginTop: "2%"}}></div>
                        ...
                        <div style={{paddingTop: "30px", marginBottom: "2%"}}><Divider /></div>
                        
                        <AddQuestionsModal questions={questions} examLinkedQuestions={ExamQuestions} setExamQuestions={setExamQuestions} updateExamQuestions={updateExamQuestions}/>
                </>
        );
}